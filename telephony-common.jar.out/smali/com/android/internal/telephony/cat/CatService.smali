...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v3, "Unrecognized CAT command: "
    ...
    invoke-direct {v2, v3, v13}, Lcom/android/internal/telephony/cat/RilMessage;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v2, v3, v4}, Lcom/android/internal/telephony/cat/RilMessage;-><init>(ILjava/lang/String;)V
    ...
    .line 877
    :pswitch_6
    const-string/jumbo v1, "MSG_ID_ICC_CHANGED"
    ...
    const-string/jumbo v2, "Icc REFRESH with exception: "
    ...
    .end local v8    # "ar":Landroid/os/AsyncResult;
    :cond_3
    const-string/jumbo v1, "IccRefresh Message is null"
    ...
    .line 895
    :pswitch_8
    const-string/jumbo v1, "Received CAT CC Alpha message from card"
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/cat/CatService;->broadcastAlphaMessage(Ljava/lang/String;)V
    ...
    .line 904
    .local v9, "callCtrlInfo":[Ljava/lang/String;
    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "callCtrlInfo.length: "
    ...
    .line 923
    .local v7, "alphaId":Ljava/lang/String;
    :try_start_2
    move-object/from16 v0, v17
    ...
    const-string/jumbo v2, "CC Alpha msg: "
    ...
    .line 929
    new-instance v19, Lcom/android/internal/telephony/cat/TextMessage;

    invoke-direct/range {v19 .. v19}, Lcom/android/internal/telephony/cat/TextMessage;-><init>()V

    .line 930
    .local v19, "textMessage":Lcom/android/internal/telephony/cat/TextMessage;
    new-instance v10, Lcom/android/internal/telephony/cat/CommandDetails;

    invoke-direct {v10}, Lcom/android/internal/telephony/cat/CommandDetails;-><init>()V

    .line 931
    .local v10, "cmdDet":Lcom/android/internal/telephony/cat/CommandDetails;
    sget-object v1, Lcom/android/internal/telephony/cat/AppInterface$CommandType;->CALLCTRL_RSP_MSG:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    ...
    iput v1, v10, Lcom/android/internal/telephony/cat/CommandDetails;->typeOfCommand:I

    .line 932
    move-object/from16 v0, v19

    iput-object v7, v0, Lcom/android/internal/telephony/cat/TextMessage;->text:Ljava/lang/String;

    .line 933
    new-instance v12, Lcom/android/internal/telephony/cat/CallCtrlBySimParams;
    ...
    invoke-direct {v12, v10, v0, v1, v2}, Lcom/android/internal/telephony/cat/CallCtrlBySimParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/TextMessage;ILjava/lang/String;)V

    .line 935
    .local v12, "cmdParams":Lcom/android/internal/telephony/cat/CallCtrlBySimParams;
    new-instance v11, Lcom/android/internal/telephony/cat/CatCmdMessage;

    invoke-direct {v11, v12}, Lcom/android/internal/telephony/cat/CatCmdMessage;-><init>(Lcom/android/internal/telephony/cat/CommandParams;)V
    ...
    .line 912
    .end local v7    # "alphaId":Ljava/lang/String;
    .end local v10    # "cmdDet":Lcom/android/internal/telephony/cat/CommandDetails;
    .end local v11    # "cmdMsg":Lcom/android/internal/telephony/cat/CatCmdMessage;
    .end local v12    # "cmdParams":Lcom/android/internal/telephony/cat/CallCtrlBySimParams;
    .end local v19    # "textMessage":Lcom/android/internal/telephony/cat/TextMessage;
    .local v17, "rawData":[B
    :cond_5
    :try_start_3
    const-string/jumbo v1, "Null CC alpha id."
    ...
    const-string/jumbo v1, "CC message drop"
    ...
    const-string/jumbo v1, "IndexOutOfBoundsException adnStringFieldToString"
    ...
    .line 938
    .end local v7    # "alphaId":Ljava/lang/String;
    .end local v9    # "callCtrlInfo":[Ljava/lang/String;
    .end local v16    # "e":Ljava/lang/IndexOutOfBoundsException;
    .end local v17    # "rawData":[B
    :cond_6
    const-string/jumbo v1, "CAT Alpha message: unexpected response type!"
    ...
    .line 941
    :cond_7
    const-string/jumbo v1, "CAT Alpha message: ar.result is null"
    ...
    .end local v8    # "ar":Landroid/os/AsyncResult;
    :cond_8
    const-string/jumbo v1, "CAT Alpha message: msg.obj is null"
    ...
    .line 949
    const-string/jumbo v1, "SMS SEND TIMEOUT"
    ...
    .line 965
    const-string/jumbo v1, "handleMsg : MSG_ID_SEND_SMS_RESULT"
    ...
    const-string/jumbo v2, "The Msg ID data:"
    ...
    .line 978
    const-string/jumbo v1, "SMS SEND GENERIC FAIL"
    ...
    .line 989
    :sswitch_0
    const-string/jumbo v1, "SMS SEND OK"
    ...
    .line 999
    :sswitch_1
    const-string/jumbo v1, "SMS SEND FAIL - MEMORY NOT AVAILABLE"
    ...
    .line 1010
    :sswitch_2
    const-string/jumbo v1, "SMS SEND FAIL RETRY"
